...
let currentChannel1 = 0 // channel letiable for ADC 1
let config2 = 0x9C // PGAx1, 18 bit, continuous-shot conversion, channel 1
let currentChannel2 = 0 // channel letiable for ADC 2
...
export default class ADCPi {
  ...
  constructor(address1, address2, rate) {
    // <summary>
  ...
  readVoltage = (channel) => {
    ...
    return (raw * (lsb / this.pga)) * 2.471 // calculate the voltage and return it
  }
